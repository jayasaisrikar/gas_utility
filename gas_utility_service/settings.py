...
SECRET_KEY = 'django-insecure-a5&8w07p+()#w)+l$pj7yz*&(=&@pjj+8@^wli^&j9y_xs@lu6'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = []
LOGIN_REDIRECT_URL = '/'  # This will redirect to the home page after login
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / "customer_services/templates"],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
